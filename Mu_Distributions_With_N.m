...
plot(linspace(-0.5,0.5,Nbinz-1),Pstate(:,5),'r--','markersize',1,'Linewidth',1)
plot(linspace(-0.5,0.5,Nbinz-1),Pstate(:,6),'b--','markersize',1,'Linewidth',1)
plot(linspace(-0.5,0.5,Nbinz-1),Pstate(:,7),'g--','markersize',1,'Linewidth',1)
plot(linspace(-0.5,0.5,Nbinz-1),Pstate(:,8),'m--','markersize',1,'Linewidth',1)
...
plot(Gain_range,Pstate(round(Nbinz/2)+1:Nbinz-1,5),'r--','markersize',1,'Linewidth',1)
plot(Gain_range,Pstate(round(Nbinz/2)+1:Nbinz-1,6),'b--','markersize',1,'Linewidth',1)
plot(Gain_range,Pstate(round(Nbinz/2)+1:Nbinz-1,7),'g--','markersize',1,'Linewidth',1)
plot(Gain_range,Pstate(round(Nbinz/2)+1:Nbinz-1,8),'m--','markersize',1,'Linewidth',1)
% plot(linspace(-0.5,0.5,Nbinz-1),Pstate./N,'g.-','markersize',2)
xlabel('$\displaystyle \mu$', 'Interpreter','latex')
ylabel('$\displaystyle P(\tilde{\mu})$', 'Interpreter','latex')
